...
% https://github.com/jain-shobhit/SSMTool/tree/master/examples/TimoshenkoBeamIRs
% 
% Changes by M. Krack: 
%   - commented lines 55-74 (relying on tensor toolbox and 
%       multi_index_to_tensor.m, not needed for NLvib)
%   - commented lines 16-19 and 75 (try/catch)
%   - commented lines 12-15 (file name not needed as no file is stored)
%   - return 'powers' and 'coefficients' as output arguments, not 'fnl'
function [M,C,K,fext,outdof,powers,coefficients] = build_model(nElements,isViscoelastic)
...
%     save(name,'M','C','K','fnl','fext','outdof','f','powers','coefficients');
% end
end
